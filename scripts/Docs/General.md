...
# Links to Minecraft Settings: 
- server.properties file: https://minecraft.wiki/w/Server.properties
- console commands: https://minecraft.wiki/w/Commands 
    - When in server console, you do not enter the /(command), you only enter (command)
- Whitelist: https://minecraft.fandom.com/wiki/Commands/whitelist
- Operator: https://minecraft.wiki/w/Commands/op
